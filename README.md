...
MindEase AI is a modular, triple-tier web application designed to support personal emotional tracking, cognitive behavioral(CBT) reflections, and immediate mental health resources. The system is built around a botanical design system utilizing glassmorphic components to offer a peaceful, user experience.
